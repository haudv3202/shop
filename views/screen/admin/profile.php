                ...
                <div class="col-xxl-3 col-md-4">
                    <aside class="profile-sider">
                        <div class="card mb-25">
                            <div
                                class="card-body text-center pt-sm-30 pb-sm-0 px-25 pb-0"
                            >
                                <div class="account-profile">
                                    ...
                                    <div class="ap-nameAddress pb-3 pt-1">
                                        <h5 class="ap-nameAddress__title"><?php echo $_SESSION['auth_user'][0]->fullname; ?></h5>
                                        <p class="ap-nameAddress__subTitle fs-14 m-0">
                                            UI/UX Designer
                                        </p>
                                        <p class="ap-nameAddress__subTitle fs-14 m-0">
                                            <img
                                                src="../public/backend/assets/img/svg/map-pin.svg"
                                                alt="map-pin"
                                                class="svg"
                                            />London, England
                                        </p>
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                class="svg"
                                                src="../public/backend/assets/img/svg/mail.svg"
                                                alt="mail"
                                            />message
                                        </button>
                                        <button
                                            class="btn btn-primary btn-default btn-squared text-capitalize px-25"
                                            onclick="location.href='updateInfo'"
                                        >
                                            <img
                                                src="../public/backend/assets/img/svg/edit.svg"
                                                alt="user-plus"
                                                class="svg"
                                            />
                                            Edit profile
                                ...
                                <div
                                    class="card-footer mt-20 pt-20 pb-20 px-0 bg-transparent"
                                >
                                    <div
                        ...
                        <div class="card mb-25">
                            <div class="user-bio border-bottom">
                                <div
                                    class="card-header border-bottom-0 pt-sm-30 pb-sm-0 px-md-25 px-3"
                                >
                                ...
                                <div class="card-body pt-md-1 pt-0">
                                    <div class="user-bio__content">
                                        <p class="m-0">
                                            ...
                                            hendrerit facilisi id vitae enim sed ornare there
                                            suspendisse sed orci neque ac sed aliquet risus
                                            faucibus in pretium molestie nisl tempor quis odio
                                            habitant.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="user-content-info">
                                        <p class="user-content-info__item">
                                            ...
                                            /><a
                                                ...
                                                class="__cf_email__"
                                                data-cfemail="2d6e414c545942436d48554c405d4148034e4240"
                                            >[email&#160;protected]</a
                                            >
                                        </p>
                                        <p class="user-content-info__item">
                                            <img
                                                src="../public/backend/assets/img/svg/phone.svg"
                                                alt="phone"
                                                class="svg"
                                            />+44 (0161) 347 8854
                                        </p>
                                        <p class="user-content-info__item mb-0">
                                            <img
                                                src="../public/backend/assets/img/svg/globe.svg"
                                                alt="globe"
                                                class="svg"
                                            />www.example.com
                                        </p>
                                ...
                                <div class="card-body pt-md-1 pt-0">
                                    <ul class="db-social-parent mb-0">
                                        <li class="db-social-parent__item">
                                            <a
                                                class="color-facebook hover-facebook wh-44 fs-18"
                                                href="#"
                                            >
                                        ...
                                        <li class="db-social-parent__item">
                                            <a
                                                class="color-twitter hover-twitter wh-44 fs-18"
                                                href="#"
                                            >
                                        ...
                                        <li class="db-social-parent__item">
                                            <a
                                                class="color-ruby hover-ruby wh-44 fs-18"
                                                href="#"
                                            >
                                        ...
                                        <li class="db-social-parent__item">
                                            <a
                                                class="color-instagram hover-instagram wh-44 fs-18"
                                                href="#"
                                            >
                ...
                <div class="col-xxl-9 col-md-8">
                    <div class="ap-tab ap-tab-header">
                        <div class="ap-tab-header__img">
                            <img
                                src="../public/backend/assets/img/ap-header.png"
                                alt="ap-header"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card mt-25 mb-40">
                                            <div
                                                class="card-header text-capitalize px-md-25 px-3"
                                            >
                                                <h6>My products</h6>
                                                <div class="dropdown">
                                                    <a
                                                    ...
                                                    >
                                                        <img
                                                            src="../public/backend/assets/img/svg/more-horizontal.svg"
                                                            alt="more-horizontal"
                                                            class="svg"
                                                        />
                                                    </a>
                            ...
                            <div class="ap-post-content">
                                <div class="row">
                                            ...
                                            <div class="card border-0 mb-25">
                                                ...
                                                <div class="card-body p-0 px-25">
                                                    <div class="d-flex flex-column">
                                                        <div
                                                            class="border-0 flex-1 position-relative"
                                                        >
                                                            <div
                                                                class="pt-20 outline-0 pb-2 pe-0 ps-0 rounded-0 position-relative border-bottom"
                                                                tabindex="-1"
                                                            >
                                      <span
                                          class="ap-profile-image bg-opacity-secondary rounded-circle d-block position-absolute"
                                          style="
                                          background-image: url('img/ap-author.png');
                                        ...
                                        ></textarea>
                                                        ...
                                                        >
                                                            <a href="#" class="btn rounded-pill me-2">
                                                                <img
                                                                    class="svg"
                                                                    src="../public/backend/assets/img/svg/image.svg"
                                                                    alt="img"
                                                                />
                                                                Photo/Video
                                                            </a>
                                                            ...
                                                            <button
                                                                class="btn btn-primary btn-default btn-squared ms-auto ap-post-attach__btn"
                                                            >
                                                                public post
                                                            </button>
                                                        </div>
                                    ...
                                    ></span>
                                                    ...
                                                    <div class="mb-15">
                                                        <img
                                                            src="../public/backend/assets/img/post-image.png"
                                                            alt="post image"
                                                    ...
                                                    >
                                                        Nam malesuada dolor tellus pretium amet was
                                                        hendrerit facilisi tempor quis enim sed ornare
                                                        there suspendisse sed orci neque ac sed
                                                        aliquet risus faucibus in pretium molestee.
                                                    </div>
                                                </div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <img
                                                                class="svg"
                                                                src="../public/backend/assets/img/svg/thumbs-up.svg"
                                                                alt="thumbs-up"
                                                            />274
                                                        </a>
                                                        <a
                                                        ...
                                                        >
                                                            <img
                                                                class="svg"
                                                                src="../public/backend/assets/img/svg/message-square.svg"
                                                                alt="message-square"
                                                            />56</a
                                                        >
                                                        <a
                                                        ...
                                                        >
                                                            <img
                                                                class="svg"
                                                                src="../public/backend/assets/img/svg/share-2.svg"
                                                                alt="share-2"
                                                            />
                                                            share
                                                        </a>
                                                ...
                                                <div
                                                    class="card-body px-sm-25 py-20 ap-main-post__footer"
                                                >
                                                                ...
                                                                >
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <a href="#">
                                                                            <img
                                                                                class="svg"
                                                                                src="../public/backend/assets/img/svg/smile.svg"
                                                                                alt="smile"
                                                                            /></a>
                                                                        <a href="#">
                                                                            <img
                                                                        ...
                                                                        <a href="#">
                                                                            <img
                                                                                class="svg"
                                                                                src="../public/backend/assets/img/svg/paperclip.svg"
                                                                                alt="paperclip"
                                                                            /></a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="mb-3 ap-post-gallery">
                                                        <div class="ap-post-gallery-top">
                                                            <div class="ap-post-gallery__item">
                                                                <a href="img/506.png"
                                                                ><img
                                                                        src="../public/backend/assets/img/506.png"
                                                                        alt="gallery"
                                                            ...
                                                            <div class="ap-post-gallery__item">
                                                                <a href="img/907.png"
                                                                ><img
                                                                        src="../public/backend/assets/img/907.png"
                                                                        alt="gallery"
                                                                        class="w-100 img-fluid"
                                                                    /></a>
                                                            </div>
                                                        ...
                                                        <div class="ap-post-gallery-bottom">
                                                            <div class="ap-post-gallery__item">
                                                                <a href="img/brightland_3744.png"
                                                                ><img
                                                                        src="../public/backend/assets/img/brightland_3744.png"
                                                                        alt="gallery"
                                                                        class="w-100 img-fluid"
                                                                    /></a>
                                                            </div>
                                                            <div class="ap-post-gallery__item">
                                                                <a href="img/room.png"
                                                                ><img
                                                                        src="../public/backend/assets/img/room.png"
                                                                        alt="gallery"
                                                                        class="w-100 img-fluid"
                                                                    /></a>
                                                            </div>
                                                            <div class="ap-post-gallery__item">
                                                                ...
                                                                >
                                                                    <img
                                                                        src="../public/backend/assets/img/165.png"
                                                                        alt="gallery"
                                                                        class="w-100 img-fluid"
                                                                    />
                                                                    <div
                                                                        class="ap-post-gallery-overlay__content"
                                                                    >
                                          <span
                                          >26<span class="las la-plus"></span
                                              ></span>
                                                                    </div>
                                                                </a>
                                                            </div>
                                    ...
                                    ></span>
                                                ...
                                                <div
                                                    class="card-body pt-20 ap-main-post__comment"
                                                >
                                                    <div
                                      ...
                                      ></span>
                                                            ...
                                                            <div class="mb-0 flex-1 text-dark">
                                                                ...
                                                                >
                                                                    ...
                                                                    <p class="mb-0 mt-10 text-gray">
                                                                        Nam malesuada dolor tellus pretium
                                                                        amet was hendrerit facilisi tempor
                                                                        quis eni
                                                                    </p>
                                                                </div>
                                                                <ul
                                                    ...
                                                    <a
                                                        class="view-more-comment color-primary fs-13 fw-500"
                                                        href="#"
                                    ...
                                    <div class="col-xxl-4">
                                      ...
                                      ></span>
                                                        ...
                                                        <div>
                                                            <button
                                                                class="btn btn-default btn-squared color-light btn-outline-light friends-follow"
                                                            >
                                                                follow
                                                            </button>
                                                        </div>
                                      ...
                                      ></span>
                                        ...
                                        Product Designer
                                                        ...
                                                        <div class="ffw__button">
                                                            ...
                                                            >
                                                                <img
                                                                    src="../public/backend/assets/img/svg/check.svg"
                                                                    alt="check"
                                                                    class="svg"
                                                                />
                                                                follow
                                      ...
                                      ></span>
                                                            ...
                                                            <div class="ffw__title">
                                                                ...
                                                                <span class="d-block"> UI director </span>
                                                            </div>
                                                        </div>
                                                        <div class="ffw__button">
                                                            <button
                                      ...
                                      ></span>
                                        ...
                                        System Administrator
                                                    ...
                                                    <a
                                                        class="view-more-comment color-primary fs-13 fw-500 px-25 pb-20"
                                                        href="#"
                                                    >Load more friends</a
                                                    >
                                                </div>
                                        ...
                                        <div class="card global-shadow mb-25">
                                            <div class="photo-gallery-widget">
                                                ...
                                                >
                                                    <h6>photos</h6>
                                                    <a
                                                        class="color-primary fs-13 fw-500 mt-lg-0 mt-1"
                                                        href="#"
                                                    >see all</a
                                                    >
                                                </div>
                                                <div class="card-body">
                                                    <div class="wig">
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/315.png" alt="gallery" />
                                                        </div>
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/325.png" alt="gallery" />
                                                        </div>
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/design.png" alt="gallery" />
                                                        </div>
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/99.png" alt="gallery" />
                                                        </div>
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/166.png" alt="gallery" />
                                                        </div>
                                                        <div class="wig__item">
                                                            <img src="../public/backend/assets/img/287.png" alt="gallery" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="wig">
                                                        <div class="wig__item wig-overlay">
                                                            <img src="../public/backend/assets/img/juice-2.png" alt="gallery" />
                                                            <div class="wig-overlay__content">
                                                                ...
                                                                >
                                                                    <img
                                                                        class="svg"
                                                                        src="../public/backend/assets/img/svg/play.svg"
                                                                        alt="img"
                                                                    />
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="../public/backend/assets/img/cup-card.png" alt="gallery" />
                                                            <div class="wig-overlay__content">
                                                                <a
                                                                    class="wig-overlay__iconWrapper popup-youtube"
                                                                    href="https://www.youtube.com/watch?v=i9E_Blai8vk"
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img
                                                                src="../public/backend/assets/img/round-box.png"
                                                                alt="gallery"
                                                            />
                                                            <div class="wig-overlay__content">
                                                                <a
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="../public/backend/assets/img/glass.png" alt="gallery" />
                                                            <div class="wig-overlay__content">
                                                                <a
                                                                    class="wig-overlay__iconWrapper popup-youtube"
                                                                    href="https://www.youtube.com/watch?v=i9E_Blai8vk"
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            <img src="../public/backend/assets/img/bottles.png" alt="gallery" />
                                                            <div class="wig-overlay__content">
                                                                <a
                                                                    class="wig-overlay__iconWrapper popup-youtube"
                                                                    href="https://www.youtube.com/watch?v=i9E_Blai8vk"
                                                        ...
                                                        <div class="wig__item wig-overlay">
                                                            ...
                                                            <div class="wig-overlay__content">
                                                                <a
                                                                    class="wig-overlay__iconWrapper"
                                                                    href="#"
                                                                >
                                                                    <img
                                                                        class="svg"
                                ...
                                <div class="row">
                                    <div class="col-xxl-8">
                                      ...
                                      >
                                        <img
                                            class="svg"
                                            src="../public/backend/assets/img/svg/inbox.svg"
                                            alt="inbox"
                                        />
                                      </span>
                                                                <span
                                      ...
                                      >
                                        ...
                                        "
                                          ...
                                          <span class="color-primary"
                                          >Adam </span
                                          >upload website template for sale
                                                                    </h6>
                                                                </a>
                                                                <p class="d-block">5 hours ago</p>
                                                            </div>
                                      ...
                                      >
                                        <img
                                            class="svg"
                                            src="../public/backend/assets/img/svg/log-in.svg"
                                            alt="log-in"
                                        /></span>
                                                                <span
                                                                    class="profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0"
                                      ...
                                      >
                                        <img
                                            class="svg"
                                            src="../public/backend/assets/img/svg/at-sign.svg"
                                            alt="at-sign"
                                        /></span>
                                                                <span
                                                                    class="profile-image bg-opacity-secondary rounded-circle d-block avatar avatar-md m-0"
                                      ...
                                      >
                                        <img
                                            src="../public/backend/assets/img/svg/heart.svg"
                                            alt="heart"
                                            class="svg"
                                        /></span>
                                                                <span
