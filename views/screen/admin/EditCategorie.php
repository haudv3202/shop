                            ...
                            <form action="" method="post">
                                <div class="form-group mb-25">
                                    ...
                                    <input
                                        ...
                                        placeholder="Shirt"
                                        name="name_Cate"
                                        value="<?php echo isset($data_old[0]) ? $data_old[0] : $data->cate_name; ?>"
                                    />
                                ...
                                <div class="form-group mb-25">
                                    ...
                                    <input
                                        ...
                                        placeholder=""
                                        name="Slug"
                                        value="<?php echo isset($data_old[1]) ? $data_old[1] : $data->slug; ?>"
                                    />
                                ...
                                <div class="form-group mb-25">
                                    ...
                                    <input
                                        ...
                                        placeholder=""
                                        name="Desc"
                                        value="<?php echo isset($data_old[2]) ? $data_old[2] :  $data->descs; ?>"
                                    />
