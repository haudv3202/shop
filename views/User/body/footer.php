            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="footer_widget">
                        <img src="./public/frontend/assets/img/logo-light.png" class="img-footer small mb-2" alt="" />
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="footer_widget">
                        ...
                        <div class="address mt-3">
                            ...
                            <div class="scr_payment"><img src="./public/frontend/assets/img/card.png" class="img-fluid" alt="" /></div>
                        </div>
                    </div>
                </div>
