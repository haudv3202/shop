    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="sp-loading"><img src="./public/frontend/assets/img/product/15.png" alt=""><br>LOADING IMAGES</div>
                <div class="sp-wrap">
                    <a href="./public/backend/upload/<?php echo $_SESSION['dataOne']->img; ?>"><img src="./public/backend/upload/<?php echo $_SESSION['dataOne']->img; ?>" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="prd_details">
                    ...
                    <div class="prt_02 mb-3">
                        <h2 class="ft-bold mb-1"><?php echo $_SESSION['dataOne']->name; ?></h2>
                        <div class="text-left">
                            ...
                            <div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2"><?php echo number_format($_SESSION['dataOne']->price); ?>&#8363;</span><span class="ft-bold theme-cl fs-lg"><?php echo number_format((100 - $_SESSION['dataOne']->sale)/100 * $_SESSION['dataOne']->price); ?>&#8363;</span></div>
                        </div>
                    </div>

                    <div class="prt_03 mb-4">
                        <p><?php echo $_SESSION['dataOne']->detail; ?></p>
                    </div>
                    ...
                    <div class="prt_05 mb-4">
                        <div class="form-row mb-7">
                            ...
                            <div class="col-12 col-lg">
                                    ...
                                    <!-- Submit -->
                                    <button onclick="addCart(<?php echo $_SESSION['dataOne']->id; ?>)" class="btn btn-block custom-height bg-dark mb-2">
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        <div class="reviews_info">
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="./public/frontend/assets/img/team-1.jpg" class="img-fluid circle" width="90" alt="" /></div>
                            ...
                            <!-- Single Review -->
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="./public/frontend/assets/img/team-2.jpg" class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
                            ...
                            <!-- Single Review -->
                            <div class="single_rev d-flex align-items-start br-bottom py-3">
                                <div class="single_rev_thumb"><img src="./public/frontend/assets/img/team-3.jpg" class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
                            ...
                            <div class="single_rev d-flex align-items-start py-3">
                                <div class="single_rev_thumb"><img src="./public/frontend/assets/img/team-4.jpg" class="img-fluid circle" width="90" alt="" /></div>
                                <div class="single_rev_caption d-flex align-items-start pl-3">
                                    <div class="single_capt_left">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="slide_items">
                    ...
                    <!-- single Item -->
                    <?php foreach ($productRamdom as $value):?>
                            ...
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                                <div class="text-left">
                                    <div class="text-center">
                                        <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="shop-single-v1.html"><?php echo $value->name; ?></a></h5>
